...
public class EnrolledStudent extends javax.swing.JFrame {
     ...
     */public EnrolledStudent(String facultyId){
         this();
...
//Remove rows one by one from the end of the table
           for (int i = rowCount - 1; i >= 0; i--) {
            ...
            String sql="select stu_id,name,course,department from (select stu_id from takes where course_id=\""+courseId.getSelectedItem().toString()+"\" and year="+Integer.toString(d.getYear()+1900)+") as dummy natural join student";
            pst=conn.prepareStatement(sql);
            rs=pst.executeQuery(sql);
    ...
    private void courseIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_courseIdActionPerformed
        ...
        try{
             sql="select sec_id from teaches where fac_id=\""+facultyId+"\" and year="+Integer.toString(d.getYear()+1900)+" and course_id=\""+courseId.getSelectedItem().toString()+"\"";
            pst=conn.prepareStatement(sql);
            rs=pst.executeQuery(sql);
             while(rs.next()){
