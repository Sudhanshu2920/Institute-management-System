 ...
 * @author ASUS
 */
public class EnrollFacultyAdvisor extends javax.swing.JFrame {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jLabel3, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(facultyId, javax.swing.GroupLayout.DEFAULT_SIZE, 35, Short.MAX_VALUE))
        ...
        if(!a)
           JOptionPane.showMessageDialog(null, "Faculty Does Not Exists"); 
            ...
            try{
                ...
                while(rs.next()){
                    String sql2="insert into advisor(fac_id,stu_id) values(?,?)";
                    pst=conn.prepareStatement(sql2);
                    pst.setString(1,facultyId.getText());
                    pst.setString(2,rs.getString(1));
                    pst.executeUpdate();
                }
                JOptionPane.showMessageDialog(null,"Advisor has been set successfully");
            }catch(java.sql.SQLIntegrityConstraintViolationException w){
                JOptionPane.showMessageDialog(null, "Faculty has been already set up for given batch");
            }
            catch(Exception e){
                JOptionPane.showMessageDialog(null, e.getMessage());
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EnrollFacultyAdvisor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EnrollFacultyAdvisor().setVisible(true);
            }
        });
    }
