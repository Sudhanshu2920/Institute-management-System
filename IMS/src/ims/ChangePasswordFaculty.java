 ...
 * @author ASUS
 */
public class ChangePasswordFaculty extends javax.swing.JFrame {
     ...
     */
    public ChangePasswordFaculty(String facultyId)
    {
        this();
        facId=facultyId;
    }
    ...
    private void initComponents() {
        ...
        jLabel24.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ims/logout1.png"))); // NOI18N
...
dispose();        // TODO add your handling code here:
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            String sql="update faculty set password=\""+password.getText()+"\" where fac_id=\""+facId+"\"";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChangePasswordFaculty.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChangePasswordFaculty().setVisible(true);
            }
        });
    }
