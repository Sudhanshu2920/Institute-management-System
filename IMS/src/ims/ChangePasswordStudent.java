 ...
 * @author ASUS
 */
public class ChangePasswordStudent extends javax.swing.JFrame {
     ...
     */
    public ChangePasswordStudent(String studentId)
    {
        this();
        stuId=studentId;
    }
...
dispose();        // TODO add your handling code here:
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            String sql="update student set password=\""+password.getText()+"\" where stu_id=\""+stuId+"\"";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChangePasswordStudent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
