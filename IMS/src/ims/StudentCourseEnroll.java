 ...
 * @author ASUS
 */
public class StudentCourseEnroll extends javax.swing.JFrame {
     ...
     */public StudentCourseEnroll(String studentId){
         this();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StudentCourseEnroll.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StudentCourseEnroll().setVisible(true);
            }
        });
    }
