 ...
 * @author ASUS
 */
public class FacultyCourseEnroll extends javax.swing.JFrame {
     ...
     */public FacultyCourseEnroll(String facultyId){
         this();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Courses Teaching");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(credit, javax.swing.GroupLayout.DEFAULT_SIZE, 28, Short.MAX_VALUE))
    ...
    private void courseIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_courseIdActionPerformed
        ...
        if(courseId.getSelectedIndex()>0){
            try{
                String sql="select title,credits from course where course_id=\""+courseId.getSelectedItem().toString()+"\"";
                pst=conn.prepareStatement(sql);
                rs=pst.executeQuery(sql);
                rs.next();
                title.setText(rs.getString(1));
                credit.setText(rs.getString(2));
            }catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FacultyCourseEnroll.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FacultyCourseEnroll().setVisible(true);
            }
        });
    }
