 ...
 * @author ASUS
 */
public class FacultyClassroom extends javax.swing.JFrame {
     ...
     */public FacultyClassroom(String facultyId){
         this();
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(48, 48, 48)
                        .addComponent(secId, javax.swing.GroupLayout.PREFERRED_SIZE, 107, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(secId, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(41, 41, 41)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void courseIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_courseIdActionPerformed
        ...
        if(courseId.getSelectedIndex()>0){
            try{
                String sql="select sec_id from teaches where course_id=\""+courseId.getSelectedItem().toString()+"\" and year="+Integer.toString(d.getYear()+1900)+" and semester in"+currentSemester;
                pst=conn.prepareStatement(sql);
                rs=pst.executeQuery(sql);
                while(rs.next())
                    secId.addItem(rs.getString(1));
    ...
    private void secIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_secIdActionPerformed
        ...
        if(courseId.getSelectedIndex()>0){
            try{
                String sql="select building,roomnumber from sec_class where course_id=\""+courseId.getSelectedItem().toString()+"\" and sec_id=\""+secId.getSelectedItem().toString()+"\" and year="+Integer.toString(d.getYear()+1900);
                pst=conn.prepareStatement(sql);
                rs=pst.executeQuery(sql);
                rs.next();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FacultyClassroom.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FacultyClassroom().setVisible(true);
            }
        });
    }
